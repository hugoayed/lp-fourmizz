    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-6 text-start my-auto" id="leftCol">
          <h1 id="title">Créer mon compte</h1>
          <form @submit.prevent="submit">
            <label for="name">Nom</label>
            <input type="text" name="name" placeholder="Fourmizz" />

            <label for="name">Prénom</label>
            <input type="text" name="name" placeholder="Agency" />
            ...
            <label for="name">Retapez votre mot de passe</label>
