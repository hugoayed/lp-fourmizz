...
<p>Ce site web est exploité par CompostAll. Partout sur le site, nous employons les termes " nous ", " notre " et " nos " en référence à CompostAll. Ce site web, y compris l'ensemble des informations, outils et services auquel il donne accès, est offert par CompostAll à l'utilisateur que vous êtes, à condition que vous acceptiez la totalité des modalités, conditions, politiques et avis stipulés ici.</p>
...
<p>Nous ne sommes pas responsables des préjudices ou dommages liés à l’achat ou à l’utilisation de biens, services, ressources, contenus ou de toute autre transaction reliée à ces sites web tiers. Veuillez lire attentivement les politiques et pratiques de ces tiers et assurez-vous de bien les comprendre avant de vous engager dans une transaction. Les plaintes, réclamations, préoccupations ou questions concernant les produits de tiers doivent être adressées à ces mêmes tiers.</p>
    ...
    <h3>SECTION 9 – COMMENTAIRES, RETOURS D'EXPÉRIENCE ET AUTRES SOUMISSIONS</h3>
...
<h3>SECTION 13 – EXCLUSION DE GARANTIES ET LIMITATION DE RESPONSABILITÉ</h3>
...
<p>Vous acceptez d’indemniser, de défendre et de tenir CompostAll et notre société mère, nos filiales, sociétés affiliées, partenaires, responsables, directeurs, agents, contractants, concédants, prestataires de services, sous-traitants, fournisseurs, stagiaires et employés, quittes de toute réclamation ou demande, y compris d'honoraires raisonnables d’avocat, émise par un quelconque tiers à cause de ou consécutivement à votre violation des présentes Conditions d’utilisation ou des documents auxquels elles font référence, ou à votre violation de quelconques lois ou droits d’un tiers.</p>
    ...
    <h3>SECTION 15 – DISSOCIABILITÉ</h3>
...
<h3>
SECTION 18 – LOI APPLICABLE</h3>

<p>Les présentes Conditions d’utilisation, ainsi que tout accord distinct par lequel nous vous fournissons les Services sont régis et interprétés en vertu des lois de 20 rue de bonne, Créteil, IDF, 94000, France.</p>

<h3>
SECTION 19 – MODIFICATIONS APPORTÉES AUX CONDITIONS D’UTILISATION</h3>
...
<h3>
SECTION 20 – COORDONNÉES</h3>

<p>Les questions relatives aux Conditions d’utilisation doivent nous être envoyées à hugoayed@gmail.com.</p>
    </section>
</template>